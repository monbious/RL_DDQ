for ((i=1; i<= 3; i++));do
let "seed=$i*100"
python run.py --agt 10 \
--usr 2 --max_turn 40 --movie_kb_path ./deep_dialog/data/movie_kb.1k.p --dqn_hidden_size 80 \
...
--write_model_dir ./deep_dialog/checkpoints/Test_DQNZ_k20_mcts_run$i \
